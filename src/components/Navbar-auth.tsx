...
const Navbar: FC<NavbarProps> = ({}) => {
  return (
    <div className="bg-[#474747] h-[5rem] text-white flex justify-between lg:px-20 px-4 items-center ">
      <div>
        <h1 className=" font-extralight text-xl max-sm:text-sm monts hover:border-b-2 slideInLeft">
      ...
      <div className=" flex  gap-4  ">
        <Link href="/auth/login">
          <Button
           ...
           font-extralight max-md:px-6 max-sm:text-sm monts ease-in hover:scale-105 duration-150 slideInRight"
          >
            LOG IN
          </Button>
        </Link>
